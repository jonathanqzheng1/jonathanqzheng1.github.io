...
const ExampleSent = Vue.component('example-sent', {
    template: `
    <div class="ex-sent">
      <p class="sent-desc">Context:</p>
      <div class="sent">
          <p><span class="f5"><slot name="given-idiom"></slot></span></p>
      </div>
      <p class="sent-desc">Chinese Input:</p>
      <div class="sent">
          <p><span class="f5"><slot name="zh-sent"></slot></span></p>
      </div>
      <p class="sent-desc">English Translation:</p>
      <div class="sent">
          <p class="mb1"><span class="f5"><slot name="en-sent"></slot></span></p>
      </div>
